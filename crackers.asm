...
; ---------------------------------------------------------------------------
	...
	include	"crackers.macros.asm"
	include "crackers.constants.asm"
	include "crackers.variables.asm"

RomStart:	dc.l $FF0200,		EntryPoint,	ErrorTrapper,	ErrorTrapper
...
SetupValues:	dc.w $8000		; VDP register Start
		...
		dc.w $0100		; VDP register Number increase (Used for Z80 functioning too)
...
loc_450:
		btst	#0,(z80_bus_request).l				; has the Z80 stopped?
...
loc_C70:
		...
		bcs.w	loc_D10
		andi.b	#$F,d0
		move.b	d0,mappings(a1)
		bsr.s	sub_C48
		bcs.w	loc_D10
		andi.b	#$F,d0
		move.b	d0,art_tile(a1)
		moveq	#0,d6
		bsr.w	sub_C2E
		bcs.w	loc_D10
		andi.b	#$F,d0
...
loc_1946:
		...
		move.w	d7,2(a0)
		move.w	#$8000,4(a0)
		move.l	#$197A,mappings(a0)
		moveq	#0,d7
		move.l	d7,art_tile(a0)
		move.l	d7,8(a0)
		move.l	d7,$C(a0)
		movem.l	(sp)+,d7
		rts
...
GameModeArray:
		...
		nop					; (these "nop"s don't do anything but take up the space of 2 bytes)
							; (as each mode is within "8" and the "jmp"s take up the space of 6 bytes)
; ---------------------------------------------------------------------------
...
; ---------------------------------------------------------------------------
		...
		nop
; ---------------------------------------------------------------------------
		jmp	Levels				; Level Zones (18)
		nop
; ---------------------------------------------------------------------------
		jmp	UnkRet001			; Null (20)
		nop
; ---------------------------------------------------------------------------
		jmp	UnkRet002			; Null (28)
		nop
; ---------------------------------------------------------------------------
		jmp	LevelSelect			; Level Select (on Main Menu) (30)
		nop
; ---------------------------------------------------------------------------
		jmp	UnkRet003			; Null (38)
		nop
; ---------------------------------------------------------------------------
		jmp	OptionSoundTest			; Options (Sound Test) (40)
		nop
; ---------------------------------------------------------------------------
...
PlayMusic:	; note that this is literally the same as MegaPCM's "PlaySample" routine... idk why lol
		stopZ80			; stop the Z80
...
loc_6BD8:				; CODE XREF: ROM:000069CEj
		lea	($FFFFD164).w,a0
		move.l	art_tile(a0),d0
		move.b	3(a0),d0
		move.l	d0,(a0)+
		move.l	art_tile(a0),(a0)+
		move.l	art_tile(a0),d0
		move.b	3(a0),d0
		move.l	d0,(a0)+
		move.l	art_tile(a0),(a0)+
...
loc_7EF8:
		...
		jsr	sub_8064			; pause menu bar related?
		jsr	sub_CCCA			; commented out causes screen not to follow durin normal play, and stars on the tether didn't animate
		jsr	sub_81F8			; Sonic/Tails object related
		jsr	sub_82B2			; deformation/screen control??
		move	#$2700,sr
		jsr	sub_1640			; object loading routine/sprite building (We think)
		move	#$2300,sr
		rts
...
loc_8236:				; CODE XREF: sub_821C+Cj
		...
		tst.w	d0
		bpl.s	loc_8254
		move.w	#4,ani_frame(a6)
		move.w	#$8000,art_tile(a6)
		bra.s	loc_8260
; ---------------------------------------------------------------------------

loc_8254:				; CODE XREF: sub_821C+28j
		move.w	#4,ani_frame(a6)
		move.w	#$8800,art_tile(a6)
...
loc_8260:				; CODE XREF: sub_821C+1Ej sub_821C+36j
		...
		tst.w	d1
		bpl.s	loc_827E
		move.w	#6,ani_frame(a6)
		move.w	#$8000,art_tile(a6)
		rts
; ---------------------------------------------------------------------------

loc_827E:				; CODE XREF: sub_821C+52j
		move.w	#2,ani_frame(a6)
		move.w	#$8000,art_tile(a6)
		rts
; ---------------------------------------------------------------------------
...
loc_828C:				; CODE XREF: sub_821C+16j sub_821C+48j
		or.w	d1,d0
		bne.s	locret_82A4
		move.w	ani_frame(a6),d0
		beq.s	locret_82A4
		lsr.w	#1,d0
		subq.w	#1,d0
		move.b	d0,$28(a6)
		move.w	#0,ani_frame(a6)
...
loc_9DCE:				; CODE XREF: sub_9DC6+2Ej
		...
		movea.l	a3,a0
		dc.b $30, $29, $00, $00	; move.w  0(a1),d0
		move.w	mappings(a1),d1
		move.w	$18(a1),d4
		jsr	sub_1272
		movea.l	a0,a3
		jsr	sub_14E4
		movem.l	(sp)+,d0-a6
		addi.w	#$10,mappings(a1)
		dbf	d7,loc_9DCE
		move.w	d0,mappings(a1)
		rts
...
loc_A38A:				; CODE XREF: ROM:0000A312j
		...
		move.w	$A(a5),d0
		beq.s	loc_A3A6
		move.l	#$100,ani_frame(a6)
		tst.w	d0
		bmi.s	locret_A3A4
		move.l	#$200,ani_frame(a6)
...
loc_A45A:				; CODE XREF: ROM:0000A448j
		...
		andi.w	#6,d0
		add.w	d2,d0
		move.w	d0,ani_frame(a6)
		andi.b	#$18,d1
		move.b	d1,art_tile(a6)
		rts
; ---------------------------------------------------------------------------
...
loc_A4F0:				; CODE XREF: ROM:0000A4DAj
		add.w	$2C(a6),d0
		move.w	d0,$2C(a6)
		move.w	#$1A,ani_frame(a6)
		andi.b	#3,$28(a6)
		rts
; ---------------------------------------------------------------------------

loc_A506:				; DATA XREF: ROM:0000A296o
		cmpi.l	#$200,ani_frame(a6)
		beq.s	loc_A51E
		tst.b	(a5)
		bmi.s	loc_A530
		bsr.w	sub_AA76
...
loc_A7A6:				; CODE XREF: ROM:0000A792j
		...
		andi.b	#8,d0
		move.b	d0,art_tile(a6)
		move.l	#$1C0000,ani_frame(a6)
		move.w	$A(a5),d0
		bpl.s	locret_A7CC
		move.l	#$1C0100,ani_frame(a6)
...
loc_B4A2:				; CODE XREF: ROM:0000B516j
		...
		lsr.w	#3,d0
		andi.w	#$1E,d0
		move.w	word_B4CC(pc,d0.w),ani_frame(a6)
		clr.b	art_tile(a6)
		moveq	#0,d0
		moveq	#$FFFFFFFE,d1
		bra.w	loc_CA8A
...
; ---------------------------------------------------------------------------
		...
		move.b	$28(a5),d0
		add.w	d0,d0
		move.w	word_B69A(pc,d0.w),ani_frame(a6)
		rts
; ---------------------------------------------------------------------------
word_B69A:	dc.w 0
		dc.w 4
...
; ---------------------------------------------------------------------------
		...
		move.b	$28(a5),d0
		add.w	d0,d0
		move.w	word_B7C6(pc,d0.w),ani_frame(a6)
		rts
; ---------------------------------------------------------------------------
word_B7C6:	dc.w $FC
		dc.w $100
...
loc_B8A2:				; CODE XREF: ROM:0000B91Aj
		...
		lsr.w	#3,d0
		andi.w	#$1E,d0
		move.w	word_B8D0(pc,d0.w),ani_frame(a6)
		clr.b	art_tile(a6)
		moveq	#0,d0
		moveq	#$FFFFFFFE,d1
		move.b	art_tile(a5),d2
		bra.w	loc_CA8A
; ---------------------------------------------------------------------------
word_B8D0:	dc.w $20
		dc.w $1C
...
; ---------------------------------------------------------------------------
		...
		move.b	$28(a5),d0
		add.w	d0,d0
		move.w	word_BBD8(pc,d0.w),ani_frame(a6)
		rts
; ---------------------------------------------------------------------------
word_BBD8:	dc.w $F0
		dc.w $F4
...
; ---------------------------------------------------------------------------
		...
		movep.l	d0,$6E(a0)
		ori.l	#$4302E,d0
		dc.b $00, $2A, $06, $40, $00, $20 ; ori.b   #$40,art_tile(a2)
		cmpi.w	#$500,d0
		bcs.s	loc_BCA0
		moveq	#0,d0
...
; ---------------------------------------------------------------------------
		ori.w	#$80,4(a6) ; '�'
		move.w	#$67,ani_frame(a6) ; 'g'
		moveq	#$FFFFFFF0,d0
		moveq	#0,d1
		move.b	#0,art_tile(a6)
		tst.b	$28(a5)
		beq.s	loc_BCE6
		move.b	#$18,art_tile(a6)
...
; ---------------------------------------------------------------------------
		...
		move.b	$28(a5),d0
		add.w	d0,d0
		move.w	word_BDFC(pc,d0.w),ani_frame(a6)
		moveq	#$FFFFFFE0,d0
		moveq	#$FFFFFFFC,d1
		bsr.w	sub_CA82
		rts
...
loc_C7E0:				; CODE XREF: ROM:0000C7D4j
		lea	PlayerArtStuffIndex(pc,d0.w),a3
		movea.l	(a3),a0
		movea.l	art_tile(a3),a1
		movea.l	$40(a3),a2
		movea.l	$60(a3),a3
		move.w	ani_frame(a6),d0		; load animation frame number?
		adda.w	(a0,d0.w),a0
		moveq	#0,d1
		move.b	$28(a6),d1
		move.b	3(a0,d1.w),d0
...
loc_C832:				; CODE XREF: ROM:0000C826j
		...
		rts
; ---------------------------------------------------------------------------
PlayerArtStuffIndex:	dc.l ANI_Sonic
		dc.l ANI_Tails
		dc.l 0
		dc.l 0
		dc.l 0
...
loc_D1E2:				; CODE XREF: sub_D1E0+1Ej
		...
		move.w	#$80,4(a0) ; '�'
		move.w	#$800,6(a0)
		move.l	#TethCodingValue,mappings(a0)
		dbf	d7,loc_D1E2
...
loc_D2A8:				; CODE XREF: ROM:ObjTablej
		moveq	#7,d0
		bclr	d0,$28(a6)
		beq.s	loc_D2D6
		move.l	#Map_SpringLR,mappings(a6)
		move.w	#$407,art_tile(a6)
		move.w	#$8080,4(a6)
		move.b	#8,$22(a6)
		move.b	#$10,$23(a6)
		move.w	#0,status(a6)
...
loc_D484:				; CODE XREF: ROM:0000D22Cj
		...
		bclr	d0,$28(a6)
		beq.s	loc_D4B2
		move.l	#Map_SpringUp,mappings(a6)
		move.w	#$407,art_tile(a6)
		move.w	#$8080,4(a6)
		move.b	#$10,$22(a6)
		move.b	#8,$23(a6)
...
loc_D660:				; CODE XREF: ROM:0000D238j
		...
		bclr	d0,$28(a6)
		beq.s	loc_D68E
		move.l	#Map_SpringAngUp,mappings(a6)
		move.w	#$407,art_tile(a6)
		move.w	#$8080,4(a6)
		move.b	#$C,$22(a6)
		move.b	#$C,$23(a6)
...
loc_DB8C:				; CODE XREF: ROM:0000D25Cj
		...
		bclr	d0,$28(a6)
		beq.s	loc_DBBA
		move.l	#Map_SpringLR,mappings(a6)	; mappings to load for object
		move.w	#$2C07,art_tile(a6)
		move.w	#$8080,4(a6)
		move.b	#8,$22(a6)
		move.b	#$10,$23(a6)
		move.w	#0,status(a6)
...
loc_E4FE:				; CODE XREF: ROM:0000D278j
		...
		bclr	d0,$28(a6)
		beq.s	loc_E526
		move.l	#Map_SpikesUpLrg,mappings(a6)
		move.w	#$23BF,art_tile(a6)
		move.w	#$8080,4(a6)
		move.b	#$10,$22(a6)
		move.b	#$10,$23(a6)
...
loc_E64E:				; CODE XREF: ROM:0000D280j
		...
		bclr	d0,$28(a6)
		beq.s	loc_E676
		move.l	#Map_SpikesLR,mappings(a6)
		move.w	#$23BF,art_tile(a6)
		move.w	#$8080,4(a6)
		move.b	#$10,$22(a6)
		move.b	#$10,$23(a6)
...
loc_E79E:				; CODE XREF: ROM:0000D288j
		...
		bclr	d0,$28(a6)
		beq.s	loc_E7C6
		move.l	#Map_SpikesAng,mappings(a6)
		move.w	#$2BBF,art_tile(a6)
		move.w	#$8080,4(a6)
		move.b	#$C,$22(a6)
		move.b	#$C,$23(a6)
...
loc_ED7C:				; CODE XREF: ROM:0000EBCCj
		...
		andi.w	#3,$24(a6)
		bne.s	loc_EDA6
		addq.w	#1,ani_frame(a6)
		andi.w	#7,ani_frame(a6)
		moveq	#0,d2
		move.w	ani_frame(a6),d2
		lsl.l	#1,d2
		lea	($FFFFD3E4).w,a0
...
; ---------------------------------------------------------------------------
AL01:		dcb.b $10000-AL01,$FF			; Aligned for Z80
; ---------------------------------------------------------------------------
...
; ---------------------------------------------------------------------------
AL03:		dcb.b $18000-AL03,$FF			; Aligned
; ---------------------------------------------------------------------------
...
; ---------------------------------------------------------------------------
AL04:		dcb.b $20000-AL04,$FF			; Aligned
; ---------------------------------------------------------------------------
...
; ---------------------------------------------------------------------------
AL05:		dcb.b $2C000-AL05,$FF			; Aligned
; ---------------------------------------------------------------------------
...
; ---------------------------------------------------------------------------
AL06:		dcb.b $30000-AL06,$FF			; Aligned
; ---------------------------------------------------------------------------
ARTUNC_HUD:
...
; ---------------------------------------------------------------------------
AL07:		dcb.b $60000-AL07,$FF			; Aligned
; ---------------------------------------------------------------------------
ARTUNC_SonicArms:
...
; ---------------------------------------------------------------------------
AL08:		dcb.b $64000-AL08,$FF			; Aligned
; ---------------------------------------------------------------------------
ARTUNC_TailsArms:
...
; ---------------------------------------------------------------------------
AU01:		dcb.b $6C000-AU01,$FF			; Aligned
; ---------------------------------------------------------------------------
...
; ---------------------------------------------------------------------------
AU02:		dcb.b $70000-AU02,$FF			; Aligned
; ---------------------------------------------------------------------------
...
; ---------------------------------------------------------------------------
AU03:		dcb.b $72000-AU03,$FF			; Aligned
; ---------------------------------------------------------------------------
...
; ---------------------------------------------------------------------------
AU04:		dcb.b $74000-AU04,$FF			; Aligned
; ---------------------------------------------------------------------------
...
; ---------------------------------------------------------------------------
AU05:		dcb.b $76000-AU05,$FF			; Aligned
; ---------------------------------------------------------------------------
...
; ---------------------------------------------------------------------------
AU06:		dcb.b $80000-AU06,$FF			; Aligned
; ---------------------------------------------------------------------------
...
; ---------------------------------------------------------------------------
AU06_B:		dcb.b $90000-AU06_B,$FF			; Aligned
; ---------------------------------------------------------------------------
ARTUNC_SonicField:
...
; ---------------------------------------------------------------------------
AU07:		dcb.b $96000-AU07,$FF			; Aligned
; ---------------------------------------------------------------------------
...
; ---------------------------------------------------------------------------
AU08:		dcb.b $98000-AU08,$FF			; Aligned
; ---------------------------------------------------------------------------
ARTUNC_UnknownHud:
...
; ---------------------------------------------------------------------------
AU08_B:		dcb.b $A0000-AU08_B,$FF			; Aligned
; ---------------------------------------------------------------------------
...
; ---------------------------------------------------------------------------
AU09:		dcb.b $AC000-AU09,$FF			; Aligned
; ---------------------------------------------------------------------------
...
; ---------------------------------------------------------------------------
AU0A:		dcb.b $B0000-AU0A,$FF			; Aligned
; ---------------------------------------------------------------------------
ARTUNC_TailsField:
...
; ---------------------------------------------------------------------------
AU0B:		dcb.b $B6000-AU0B,$FF			; Aligned
; ---------------------------------------------------------------------------
...
; ---------------------------------------------------------------------------
AU0C:		dcb.b $C0000-AU0C,$FF			; Aligned
; ---------------------------------------------------------------------------
...
; ---------------------------------------------------------------------------
AU0D:		dcb.b $CC000-AU0D,$FF			; Aligned
; ---------------------------------------------------------------------------
...
; ---------------------------------------------------------------------------
AU0E:		dcb.b $D6000-AU0E,$FF			; Aligned
; ---------------------------------------------------------------------------
...
; ---------------------------------------------------------------------------
AU0F:		dcb.b $D8000-AU0F,$FF			; Aligned
; ---------------------------------------------------------------------------
...
; ---------------------------------------------------------------------------
AU10:		dcb.b $E0000-AU10,$FF			; Aligned
; ---------------------------------------------------------------------------
...
; ---------------------------------------------------------------------------
AU11:		dcb.b $E4000-AU11,$FF			; Aligned
; ---------------------------------------------------------------------------
...
; ---------------------------------------------------------------------------
AU12:		dcb.b $E6000-AU12,$FF			; Aligned
; ---------------------------------------------------------------------------
...
; ---------------------------------------------------------------------------
AU13:		dcb.b $EC000-AU13,$FF			; Aligned
; ---------------------------------------------------------------------------
...
; ---------------------------------------------------------------------------
AU14:		dcb.b $F0000-AU14,$FF			; Aligned
; ---------------------------------------------------------------------------
...
; ---------------------------------------------------------------------------
AU15:		dcb.b $F2000-AU15,$FF			; Aligned
; ---------------------------------------------------------------------------
...
; ---------------------------------------------------------------------------
AU16:		dcb.b $F4000-AU16,$FF			; Aligned
; ---------------------------------------------------------------------------
...
; ---------------------------------------------------------------------------
AU17:		dcb.b $F6000-AU17,$FF			; Aligned
; ---------------------------------------------------------------------------
...
; ---------------------------------------------------------------------------
ALEND		dcb.b $100000-ALEND,$FF			; Aligned
		END
; ---------------------------------------------------------------------------
; ===========================================================================